...
export default function About() {
  return (
    <div className="about-us">
      ...
      <div className="content">
        <div className="left-column">
          <p>Для виконання статутної діяльності, Громадська організація &quotІнваком&quot у 2019 році виступило засновником Підприємства об&apos;єднання громадян &quot;Інваком-МНС&quot;, яке займається працевлаштуванням осіб з інвалідністю, повним циклом збірки підйомника, що має сертифікацію відповідності міністерства України.</p>
      ...
      <div className="content">
        <div className="lower-column">
          ...
          <p>Відповідно початок війни спричинив закриття суттєвої кількості робочих місць, в сім&apos;ях, де виховується чи знаходиться під опікою чи піклуванням особа/би з інвалідністю, опинились у надзвичайно складних умовах.</p>
          <p>Наша громадська організація у зв&apos;язку із надзвичайною ситуацією, спричиненою війною, зміщує акцент своєї діяльності на адресній допомозі тим, хто її зараз потребує у першу чергу, а саме маються на увазі особи з інвалідністю та сім’ї в яких під опікою чи піклуванням знаходиться особа з інвалідністю.</p>
        </div>
